    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "admin@.techpro.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "user@techpro.com", "+1 (123) 000-0001", new string[] { userRoleName });
            ...
            if (!await _context.Customers.AnyAsync() && !await _context.ProductCategories.AnyAsync())
            {
                ...
                {
                    Name = "Harhsit Porwal",
                    Email = "harshit@techpro.com",
                    PhoneNumber = "+81123456789",
                    Address = "Some fictional Address, Street 123, noida",
                    City = "noida",
                    Gender = Gender.Male,
                    DateCreated = DateTime.UtcNow,
                    DateModified = DateTime.UtcNow
